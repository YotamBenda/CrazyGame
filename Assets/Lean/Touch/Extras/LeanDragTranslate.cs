	...
	public class LeanDragTranslate : MonoBehaviour
	{
		...
		private void Translate(Vector2 screenDelta)
		{
			...
			if (camera != null)
			{
                ...
                var tempScreenPoint = new Vector2(screenDelta.x, screenDelta.y);
                screenPoint += (Vector3)tempScreenPoint * Sensitivity;
